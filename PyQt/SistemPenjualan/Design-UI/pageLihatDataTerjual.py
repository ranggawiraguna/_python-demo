...
# Form implementation generated from reading ui file 'pageLihatDataTerjual.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Frame.setText("")
        self.Frame.setPixmap(QtGui.QPixmap("../mainApplication/Picture/FrameLihatDataTerjual.jpg"))
        self.Frame.setScaledContents(True)
        self.Frame.setObjectName("Frame")
        self.TabelData = QtWidgets.QTableWidget(self.widget)
        self.TabelData.setGeometry(QtCore.QRect(51, 101, 400, 311))
        self.TabelData.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.TabelData.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        ...
        self.TabelData.horizontalHeader().setDefaultSectionSize(89)
        self.TabelData.horizontalHeader().setMinimumSectionSize(89)
        self.TabelData.horizontalHeader().setSortIndicatorShown(False)
        ...
        self.buttonUnduh.setGeometry(QtCore.QRect(238, 417, 31, 31))
        ...
        self.Teks.setGeometry(QtCore.QRect(237, 446, 41, 16))
