...
# Form implementation generated from reading ui file 'pageDeleteDataPenjualan.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Frame.setText("")
        self.Frame.setPixmap(QtGui.QPixmap("../mainApplication/Picture/FrameDeleteDataPenjualan.jpg"))
        ...
        self.buttonUnduh.setGeometry(QtCore.QRect(210, 384, 81, 31))
        self.buttonUnduh.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.buttonUnduh.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../mainApplication/Picture/buttonDelete.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label.setGeometry(QtCore.QRect(66, 429, 367, 31))
        font = QtGui.QFont()
