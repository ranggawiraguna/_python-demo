...
#Mode write 'w'
file = open(r"E:\Rangga Wiraguna\Informatika\Files\Data.txt", 'w') # r = raw >> mengabaikan karkter escape = '\n' '\t' '\\'
file.write("Nama\t : Rangga Wiraguna\nNIM \t : 1803015106\nJurusan\t : Teknik Informatika\n")
file.close()

#Mode read 'r'
print("file.read()")
file = open(r"E:\Rangga Wiraguna\Informatika\Files\Data.txt", 'r') # r = raw >> mengabaikan karkter escape = '\n' '\t' '\\'
print(file.read())
file.close()
...
file = open(r"E:\Rangga Wiraguna\Informatika\Files\Data.txt", 'a') # r = raw >> mengabaikan karkter escape = '\n' '\t' '\\'
